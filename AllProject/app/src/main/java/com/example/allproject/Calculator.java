...
public class Calculator extends AppCompatActivity {
    ...
    private Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonMultiply,
            buttonDivision, button_point, button_sub, buttonPower, button_clear, button_equal;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calculatour);
        ...
        buttonDivision = findViewById(R.id.divison_btn);
        button_point = findViewById(R.id.btnpoint);
